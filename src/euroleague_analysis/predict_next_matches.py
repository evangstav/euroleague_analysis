    ...
    for home_team, away_team in matchups:
        ...
        try:
            ...
            home_team_stats = {
                ...
                'starters_pir': home_players[home_players['is_starter'] == 1]['avg_pir'].mean(),
                'bench_pir': home_players[home_players['is_starter'] == 0]['avg_pir'].mean()
            }
            ...
            away_team_stats = {
                ...
                'starters_pir': away_players[away_players['is_starter'] == 1]['avg_pir'].mean(),
                'bench_pir': away_players[away_players['is_starter'] == 0]['avg_pir'].mean()
            }
...
if __name__ == "__main__":
    ...
    for matchup, data in features.items():
        ...
        print(home_players[['PlayerName', 'avg_pir', 'avg_points', 'games_played']].head().to_string())
        
        print(f"\n{away_team} Top Players:")
        away_players = pd.DataFrame(data['player_stats']['away_team'])
        print(away_players[['PlayerName', 'avg_pir', 'avg_points', 'games_played']].head().to_string())
